"""init of db with commit, repository and git_user tables

Revision ID: b69ddb48dbd8
Revises:
Create Date: 2025-05-11 13:42:08.141045
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("rootIsReached", sa.BOOLEAN(), server_default="0", nullable=False),
